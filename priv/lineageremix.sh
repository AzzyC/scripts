...
cd .repo/
git clone https://github.com/AzzyC/local_manifests.git -b p-android-10.0 --depth=1
cd ..
telegram -MD "Syncing [LineageOS 17.1 Remix](https://github.com/LineageOS/android)"
syncstart=`date +%s`
...
telegram -M "Sync completed in "$synctimeM" minutes or "$synctimeS" seconds, for [LineageOS 17.1 Remix](https://github.com/LineageOS/android)"
. build/envsetup.sh
lunch lineage_starlte-userdebug
telegram -MD "Build started for Starlte, [LineageOS 17.1 Remix](https://github.com/LineageOS/android)"
